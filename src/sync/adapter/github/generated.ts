// File generated by GraphQL Code Generator. Do not modify
...
export type CreateIssueMutation = { __typename?: 'Mutation', createIssue?: Maybe<{ __typename?: 'CreateIssuePayload', issue?: Maybe<{ __typename?: 'Issue', id: string }> }> };
...
export type CreateLabelMutation = { __typename?: 'Mutation', createLabel?: Maybe<{ __typename?: 'CreateLabelPayload', label?: Maybe<{ __typename?: 'Label', id: string }> }> };
...
export type UpdateLabelMutation = { __typename?: 'Mutation', updateLabel?: Maybe<{ __typename?: 'UpdateLabelPayload', clientMutationId?: Maybe<string> }> };
...
export type UpdateIssueMutation = { __typename?: 'Mutation', updateIssue?: Maybe<{ __typename?: 'UpdateIssuePayload', clientMutationId?: Maybe<string> }> };


export const RepositoryIdDocument = gql`
  ...
  repository(owner: $owner, name: $name) {
    ...
    `;
export const RepositoryStateDocument = gql`
    query repositoryState($id: ID!) {
  node(id: $id) {
    ... on Repository {
      issues(first: 100) {
        nodes {
...
export const CreateIssueDocument = gql`
  ...
  createIssue(
    input: {repositoryId: $repositoryId, title: $title, body: $body, labelIds: $labelIds}
  ) {
    issue {
      id
    }
...
export const CreateLabelDocument = gql`
  ...
  createLabel(
    input: {repositoryId: $repositoryId, name: $name, description: $description, color: $color}
  ) {
    label {
      id
    }
...
export const UpdateLabelDocument = gql`
    mutation updateLabel($id: ID!, $name: String!, $description: String!, $color: String!) {
  updateLabel(
    input: {id: $id, name: $name, description: $description, color: $color}
  ) {
    clientMutationId
  }
}
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    repositoryId(variables: RepositoryIdQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<RepositoryIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RepositoryIdQuery>(RepositoryIdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'repositoryId');
    },
    repositoryState(variables: RepositoryStateQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<RepositoryStateQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RepositoryStateQuery>(RepositoryStateDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'repositoryState');
    },
    rateLimit(variables?: RateLimitQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<RateLimitQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RateLimitQuery>(RateLimitDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'rateLimit');
    },
    ...
    createLabel(variables: CreateLabelMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateLabelMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateLabelMutation>(CreateLabelDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createLabel');
    },
    updateLabel(variables: UpdateLabelMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdateLabelMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateLabelMutation>(UpdateLabelDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'updateLabel');
    },
    updateIssue(variables: UpdateIssueMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<UpdateIssueMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateIssueMutation>(UpdateIssueDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'updateIssue');
    }
  };
}
