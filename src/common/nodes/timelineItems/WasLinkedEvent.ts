...
export const WasLinkedEventTableSpecification: NodeTableSpecification<WasLinkedEvent>
    = new NodeTableSpecification<WasLinkedEvent>("issue_timeline_wasLinkedEvent", IssueTimelineItemTableSpecification,
...
export class WasLinkedEvent extends IssueTimelineItem {
    ...
    public constructor (databaseManager: DatabaseManager, id: string,
        ...
        super(NodeType.AddedToComponentEvent, databaseManager, WasLinkedEventTableSpecification, id,
