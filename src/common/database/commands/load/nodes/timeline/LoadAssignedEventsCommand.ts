...
export class LoadAssignedEventsCommand extends LoadIssueTimelineItemsCommandBase<AssignedEvent> {
    ...
    protected getNodeResult(databaseManager: DatabaseManager, resultRow: QueryResultRow, result: QueryResult<any>): AssignedEvent {
        return new AssignedEvent(databaseManager, resultRow.id, resultRow.created_by_id, resultRow.created_at, resultRow.issue_id,
           resultRow.assignee_id, resultRow.deleted, resultRow.last_modified_at, resultRow.metadata);
    }
    ...
    protected generateQueryStart(databaseManager: DatabaseManager): QueryPart {
        return this.generateQueryStartFromTableName("assigned_event", databaseManager);
    }
