 ...
 */
export interface SyncListPropertySpecification<T, V extends SyncNode, C extends SyncNodeContainer<V>> {
    /**
     ...
     */
    applyAdd(item: SyncValue<T>, node: C): Promise<SyncUpdate | undefined>;
    /**
     ...
     *          undefined if the update was not applied
     */
    applyRemove(item: SyncValue<T>, node: C): Promise<SyncUpdate | undefined>;
    /**
     ...
     *          undefined if the update was not applied
     */
    applyAddHistoric(item: SyncValue<T>, node: C): Promise<SyncUpdate | undefined>;
    /**
     ...
     *          undefined if the update was not applied
     */
    applyRemoveHistoric(item: SyncValue<T>, node: C): Promise<SyncUpdate | undefined>;
    /**
     ...
     */
    getCurrentStatus(item: T, node: C): Promise<{ currentStatus: boolean, lastUpdatedAt?: Date}>
}