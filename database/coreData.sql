...
INSERT INTO component (id, name, description, owner_user_id, ims_system_id) VALUES ('deleted_2', 'Deleted Component', 'A Component which was deleted', 'deleted_0', 'deleted_4');
...
INSERT INTO issue_issue (id, metadata, deleted, created_at, created_by, title, updated_at, is_open, category, body_id, priority) VALUES ('deleted_6', '{"entries":[]}', true, now(), 'deleted_0', 'Deleted Issue', now(), false, 'UNCLASSIFIED', 'deleted_7', 'DEFAULT');
